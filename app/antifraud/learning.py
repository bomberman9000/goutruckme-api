...
from app.models.models import ClosedDealStat, RouteRateProfile, RouteRateStats
...
async def record_closed_deal(db: Session, deal: dict[str, Any]) -> ClosedDealStat | None:
...
async def recompute_route_stats(db: Session) -> dict[str, Any]:
    route_rows = db.query(
